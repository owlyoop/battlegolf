...
public class PawnController : MonoBehaviour, ICharacterController
{
    ...
    public void OnStateEnter(CharacterState state, CharacterState fromState)
    {
        switch (state)
        {
            ...
            case CharacterState.WorldOverview:
                {
            ...
            case CharacterState.WorldOverview:
                {
                    ...
                    _moveInputVector = new Vector3(_moveInputVector.x, verticalInput, _moveInputVector.z);
                    Vector3 targetMovementVelocity = _moveInputVector.normalized * NoClipMoveSpeed;
