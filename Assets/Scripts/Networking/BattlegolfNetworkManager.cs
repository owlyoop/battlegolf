...
public enum BattlegolfNetworkState
{
    Lobby,
    Battle
}
...
public class BattlegolfNetworkManager : NetworkManager
{
    ...
    public void ReadyStatusChanged()
    {
        ...
        if (CurrentPlayers == ReadyPlayers)
        {
            ...
            foreach (PlayerManager slot in players)
            {
                ...
                {
                    LobbyUI.instance.startGameButton.interactable = true;
                }
            }
        }
        else
    ...
    public void OnHostClickStartGame()
    {
    ...
    public override void OnServerDisconnect(NetworkConnectionToClient conn)
    {
        ...
        if (conn.authenticationData != null)
            PlayerManager.playerNames.Remove((string)conn.authenticationData);
