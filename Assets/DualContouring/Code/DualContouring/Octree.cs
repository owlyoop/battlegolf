...
public class Octree : MonoBehaviour
{
    ...
    static WorldGenGraph worldGraph = FindObjectOfType<DCGameManager>().worldGraph;
    ...
    public static readonly int[][] processEdgeMask = new int[3][]
{
    ...
    public static void GenerateMeshFromOctree(OctreeNode node, List<MeshVertex> vertexBuffer, List<int> indexBuffer)
    {
        ...
        meshRenderer.sharedMaterial = GameObject.FindObjectOfType<DCGameManager>().terrain;
    ...
    {
        DrawCubeInLines.DrawCube(node.min, node.size, Color.blue);
    }
